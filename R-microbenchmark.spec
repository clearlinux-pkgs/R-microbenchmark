...
pushd ..
cp -a microbenchmark buildavx2
popd
pushd ..
cp -a microbenchmark buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725548245
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/microbenchmark/libs/microbenchmark.so
/V4/usr/lib64/R/library/microbenchmark/libs/microbenchmark.so
